...
vector vectorA = setVector(10, 10, 0, 0);
vector vectorB = setVector(-10, 10, 0, 0);
vector vectorC = setVector(-10, -10, 0, 0);
vector vectorD = setVector(10, -10, 0, 0);

vector vectorE = setVector(10, 10, 0, 0);
vector vectorF = setVector(-10, 10, 0, 0);
vector vectorG = setVector(-10, -10, 0, 0);
vector vectorH = setVector(10, -10, 0, 0);
